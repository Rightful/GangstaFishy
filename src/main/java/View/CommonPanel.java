...
public class CommonPanel extends JPanel {
  ...
  public void about(Graphics g) {
    g.drawString(
        "A tale of a mysterious GangstaFishy as he fight and struggles to", 0,
  ...
  public void instruction(Graphics g) {
    ...
    g.drawString("Press P to Pause/Resume the game", 20,
        viewFrame.getHeight() / 4 + 120);
    g.drawString(
        "Navigate GangstaFishy through the deep dark ocean of terror and", 20,
        viewFrame.getHeight() / 4 + 150);
    g.drawString("devour smaller fishies.", 20,
        viewFrame.getHeight() / 4 + 180);
    g.drawString("Look out for bigger GangstaPiranhas and don't get eaten", 20,
        viewFrame.getHeight() / 4 + 210);
  ...
  public void gameOver(Graphics g) {
    ...
    g.drawString("Game Over " + host, viewFrame.getWidth() / 3 + 10,
        viewFrame.getHeight() / 2);
    g.drawString("Your score: " + score, viewFrame.getWidth() / 3 + 10,
        viewFrame.getHeight() / 2 + 20);
