...
public class Player extends Unit {
	...
	public Player() {
		...
		// highscore.add(new AbstractMap.SimpleEntry<String,
		// Integer>("Jasper Gangsta",99999));
	...
	public void moveDown(int fHeight) {
		...
		// if(gamePanel.getYPlayer()<(viewFrame.getHeight() -
		// gamePanel.getHeightPlayer()-30)){
		// gamePanel.setYPlayer(gamePanel.getYPlayer()+p.getSpeed());
		// }
	}

	public void update() {
		// boundary.getBounds().setSize((int)(1703/15*score),
		// (int)(1672/15*score));
